# 册 (cè) — bank entry (B7 curator promotion, main PASS)
# Source: groups/G3_coords/attempts/p3_char_0207_册/generated.py
# Note: 5 (twin 冂 frames with crossbar; PIL inline thin)
