# 乩 (jī) — bank entry (B7 curator promotion, main PASS)
# Source: groups/G3_coords/attempts/p3_char_0228_乩/generated.py
# Note: 6 (占 left + 乚 right; L-R composition inline)
