# 亘 (xuān) — bank entry (B7 curator promotion, main PASS)
# Source: groups/G3_coords/attempts/p3_char_0230_亘/generated.py
# Note: 6 (top heng + inner ri + bottom wider heng; thin uniform)
