"""Auto-composed: 力 — c33. MMH-derived anchors + bend corners."""
...
def task_01(t, screen):
    reset(t)
    draw_heng_zhe_gou(t, ('ML', 0.364, 0.464), ('MR', 0.48, 0.364), ('BC', 0.444, 0.996))
    draw_pie(t, ('TC', 0.364, 0.368), ('BL', -0.04, 1.3))
