"""自 (zi) — c57. Raw MMH + corner-by-type."""
...
def task_01(t, screen):
    reset(t)
    draw_pie(t, ('TC', 0.308, 0.224), ('C', 0.068, 0.044))
    draw_shu(t, ('ML', 0.664, 0.016), ('BL', 0.764, 1.252))
    draw_heng_zhe(t, ('ML', 0.92, 0.112), ('C', 0.96, 0.112), ('BC', 0.96, 1.132))
    draw_heng(t, ('ML', 0.912, 0.864), ('C', 0.796, 0.704))
    draw_heng(t, ('BL', 0.912, 0.46), ('BC', 0.812, 0.332))
