# Cycle 28 — Focus: 月 (Phase 2)

## MMH stroke count: 4

## Strokes (anchors from MMH measurement)
1. pie: ['TL', 0.808, 0.456] → ['BL', 0.032, 1.48]
2. heng_zhe_gou: ['TC', 0.112, 0.492] → ['BC', 0.604, 1.132]
3. heng: ['C', 0.12, 0.38] → ['C', 0.804, 0.292]
4. heng: ['BC', 0.048, 0.076] → ['C', 0.804, 0.98]
...
def task_01(t, screen):
    reset(t)
    draw_pie(t, ('TL', 0.808, 0.456), ('BL', 0.032, 1.48))
