# Cycle 20 — Focus: 下 (Phase 2)

## MMH stroke count: 3

## Strokes (anchors from MMH measurement)
1. heng: ['TL', -0.096, 0.82] → ['TR', 1.148, 0.708]
2. shu: ['TC', 0.4, 0.824] → ['BC', 0.492, 1.556]
3. dian: ['C', 0.672, 0.472] → ['BR', 0.444, 0.04]
...
def task_01(t, screen):
    ...
    draw_shu(t, ('TC', 0.4, 0.824), ('BC', 0.492, 1.556))
