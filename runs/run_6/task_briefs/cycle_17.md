# Cycle 17 — Focus: 干 (Phase 2)

## MMH stroke count: 3

## Strokes (anchors from MMH measurement)
1. heng: ['TL', 0.712, 0.58] → ['TR', 0.408, 0.396]
2. heng: ['ML', -0.132, 0.76] → ['MR', 1.188, 0.62]
3. shu: ['TC', 0.312, 0.712] → ['BC', 0.476, 1.688]
...
def task_01(t, screen):
    ...
    draw_shu(t, ('TC', 0.312, 0.712), ('BC', 0.476, 1.688))
