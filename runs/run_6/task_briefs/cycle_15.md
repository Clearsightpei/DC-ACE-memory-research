# Cycle 15 — Focus: 三 (Phase 2)

## MMH stroke count: 3

## Strokes (anchors from MMH measurement)
1. heng: ['TL', 0.716, 0.928] → ['TR', 0.34, 0.78]
2. heng: ['ML', 0.776, 0.92] → ['MR', 0.252, 0.82]
3. heng: ['BL', -0.04, 0.94] → ['BR', 1.272, 0.852]
...
def task_01(t, screen):
    ...
    save_canvas_to_png(screen, os.path.join(OUT_DIR, "01_三.png"))
