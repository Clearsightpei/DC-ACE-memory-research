# Cycle 24 — Focus: 主 (Phase 2)

## MMH stroke count: 5

## Strokes (anchors from MMH measurement)
1. dian: ['TC', 0.24, 0.288] → ['TC', 0.744, 0.708]
2. heng: ['ML', 0.568, 0.38] → ['MR', 0.456, 0.148]
3. heng: ['BL', 0.664, 0.32] → ['BR', 0.236, 0.132]
4. shu: ['C', 0.38, 0.436] → ['BC', 0.42, 1.08]
5. heng: ['BL', -0.076, 1.276] → ['BR', 1.26, 1.216]
