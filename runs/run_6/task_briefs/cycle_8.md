# Cycle 8 — Focus: 乙 (横折弯钩 compound stroke)
...
## Target
乙 — a single complex stroke with horizontal start, downward turn, leftward curve, and short upward hook tail.

## Anchors
1. heng_zhe_wan_gou(from=("TL", 0.43, 0.76), corner1=("TC", 0.79, 0.69), corner2=("BL", 0.5, 1.04), to=("BR", 0.85, 0.30))

  head (-107, 74), C1 (29, 81), C2 (-100, -154), tail (135, -80). Complex 4-point primitive.

## Three-segment stitched stroke (3 brushed_beziers, ONE primitive call)
- A: head → C1 (horizontal, slight downward at end)
- B: C1 → C2 (long curve going down-left)
- C: C2 → tail (sweep right with hook tail)
...
EXACTLY 1 top-level draw_heng_zhe_wan_gou call.
