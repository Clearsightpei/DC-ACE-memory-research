# Cycle 25 — Focus: 不 (Phase 2)

## MMH stroke count: 4

## Strokes (anchors from MMH measurement)
1. heng: ['TL', 0.2, 0.88] → ['TR', 0.968, 0.756]
2. pie: ['TC', 0.724, 0.84] → ['BL', -0.088, 0.904]
3. shu: ['C', 0.288, 0.356] → ['BC', 0.464, 1.6]
4. dian: ['C', 0.98, 0.88] → ['BR', 0.988, 0.748]
...
def task_01(t, screen):
    ...
    draw_shu(t, ('C', 0.288, 0.356), ('BC', 0.464, 1.6))
