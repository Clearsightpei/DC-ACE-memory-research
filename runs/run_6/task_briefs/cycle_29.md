# Cycle 29 — Focus: 田 (Phase 2)

## MMH stroke count: 5

## Strokes (anchors from MMH measurement)
1. shu: ['ML', 0.124, 0.028] → ['BL', 0.592, 1.052]
2. heng_zhe: ['ML', 0.388, 0.076] → ['BR', 0.348, 1.116]
3. heng: ['ML', 0.836, 0.98] → ['MR', 0.112, 0.856]
4. shu: ['C', 0.324, 0.116] → ['BC', 0.388, 0.636]
5. heng: ['BL', 0.672, 0.864] → ['BR', 0.236, 0.68]
...
EXACTLY 5 top-level draw calls in task_01.
