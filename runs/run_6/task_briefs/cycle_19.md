# Cycle 19 — Focus: 上 (Phase 2)

## MMH stroke count: 3

## Strokes (anchors from MMH measurement)
1. shu: ['TC', 0.236, 0.424] → ['BC', 0.34, 1.004]
2. heng: ['C', 0.576, 0.756] → ['MR', 0.524, 0.564]
3. heng: ['BL', -0.012, 1.18] → ['BR', 1.18, 1.152]
...
def task_01(t, screen):
    ...
    save_canvas_to_png(screen, os.path.join(OUT_DIR, "01_上.png"))
