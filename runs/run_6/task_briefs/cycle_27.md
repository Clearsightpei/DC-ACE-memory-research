# Cycle 27 — Focus: 日 (Phase 2)

## MMH stroke count: 4

## Strokes (anchors from MMH measurement)
1. shu: ['TL', 0.588, 0.812] → ['BL', 0.66, 1.268]
2. heng_zhe: ['TL', 0.888, 0.908] → ['BR', 0.204, 1.4]
3. heng: ['ML', 0.88, 0.896] → ['C', 0.776, 0.824]
4. heng: ['BL', 0.812, 1.124] → ['BC', 0.98, 0.976]
...
def task_01(t, screen):
    ...
    draw_heng_zhe(t, ('TL', 0.888, 0.908), ('TR', 0.212, 0.888), ('BR', 0.204, 1.4))
