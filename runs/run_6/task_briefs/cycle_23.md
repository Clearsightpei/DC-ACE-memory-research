# Cycle 23 — Focus: 王 (Phase 2)

## MMH stroke count: 4

## Strokes (anchors from MMH measurement)
1. heng: ['TL', 0.636, 0.888] → ['TR', 0.42, 0.74]
2. heng: ['ML', 0.776, 0.972] → ['MR', 0.276, 0.836]
3. shu: ['C', 0.368, 0.004] → ['BC', 0.412, 0.896]
4. heng: ['BL', -0.06, 1.084] → ['BR', 1.156, 1.056]
