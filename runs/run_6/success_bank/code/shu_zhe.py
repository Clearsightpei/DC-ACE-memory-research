"""竖折 (shu_zhe) — compound stroke: vertical drop + horizontal right.

Tags: tag:compound-stroke tag:shu_zhe tag:two-segment tag:楷书
Mastered: run_6 c9 (via 乚). Count ✓.

Three-anchor: from, corner, to.

Reuse:
    from shu_zhe import draw_shu_zhe
    draw_shu_zhe(t, from_anchor, corner_anchor, to_anchor)
"""
